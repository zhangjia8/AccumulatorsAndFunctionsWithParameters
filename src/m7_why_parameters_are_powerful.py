...
def run_test_even_better_draw_circles():
    ...
    # Test 1
    print('Test 1:', '\n', 'r+ = 3', '\n', '100 concentric circles', '\n', 'center is at (400, 400)')
    even_better_draw_circles(3, 100, 400, 400)

    # Test 2
    print('Test 2:', '\n', ' r+ = 10', '\n', '40 concentric circles', '\n', 'center is at (0, 400)')
    even_better_draw_circles(10, 40, 0, 400)

    # Test 3
    print('Test 3:', '\n', ' r+ = 40', '\n', '10 concentric circles', '\n', 'center is at (400, 0)')
    even_better_draw_circles(40, 10, 400, 0)


def even_better_draw_circles(n, num, x, y):
    window = rg.RoseWindow(400, 400)
